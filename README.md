...
Fins al 29 d’abril de 2026 no tenia cap cost econòmic. Des de llavors, l’ús de l’[API](https://docs.x.com/overview) de Twitter/X té un cost. De moment és un cost assumible. Si vols donar suport amb les despeses de publicació a Twitter/X:
